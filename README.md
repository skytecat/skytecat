...
|--------------|-------------|-------------|
| [DogBreedBot](https://github.com/skytecat/DogBreedBot)  | Telegram-бот для определения породы собаки по фото | Python, YOLOv8 (Ultralytics), ResNet18 (TorchVision), scikit-learn, OpenCV, Aiogram |
