...
|--------------|-------------|-------------|
| [DogBreedBot](https://github.com/skytecat/DogBreedBot)  | Telegram-бот для определения породы собаки по фото | PyTorch, scikit-learn, Ultralytics, YOLOv8, ResNet18, Aiogram 3 |
